...
export function RankingDesktopTable({ 
  ...
  return (
    <>
      ...
      <div className="hidden sm:flex items-center justify-end gap-3 mb-3">
        <div className="flex items-center bg-gray-800/80 px-3 py-1.5 rounded-full shadow-sm">
        ...
        <div className="flex items-center bg-gray-800/80 px-3 py-1.5 rounded-full shadow-sm">
          ...
          <span className="text-xs text-gray-300">Pontos extras por indicação</span>
        </div>
      </div>
